...
export default function printSummaryStats(summaryStats) {
  // some basic analysis
  summaryStats.tx_bps = filterOutliers((summaryStats.tx_bps / 1000000));
  summaryStats.rx_bps = filterOutliers((summaryStats.rx_bps / 1000000));
  summaryStats.tx_pps = filterOutliers(summaryStats.tx_pps);
  summaryStats.rx_pps = filterOutliers(summaryStats.rx_pps);
  summaryStats.rx_drop_bps = filterOutliers((summaryStats.rx_drop_bps / 1000000));
