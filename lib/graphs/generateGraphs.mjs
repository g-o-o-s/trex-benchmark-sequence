...
export async function drawGraphs(testProfile) {
  ...
  const filePath = `./output/${testProfile.dutName}/${testProfile.runName}/${pathTime}/${testProfile.name}-tune${testProfile.tuneables.replaceAll(',', '.').replaceAll('=','')}/`;
